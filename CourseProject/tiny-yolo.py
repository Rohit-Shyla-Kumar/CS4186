...
description - using tiny yolo for object detection on the VOC2012 dataset
"""
...
modelConfiguration = "models/yolo/tiny-yolo-voc.cfg";
modelWeights = "models/yolo/tiny-yolo-voc.weights";
#load model
...
print("Tiny YOLO took {:.6f} seconds".format(end - start))
